...
static const struct NvTextHtmlEntity {
    const char *name;
    quint16 code;
} entities[MAX_ENTITY] = {
    { "AElig", 0x00c6 },
...
static bool operator<( const QString &entityStr, const NvTextHtmlEntity &entity )
{
    return entityStr < QLatin1String( entity.name );
}

static bool operator<( const NvTextHtmlEntity &entity, const QString &entityStr )
{
...
{
    const NvTextHtmlEntity *start = &entities[0];
    const NvTextHtmlEntity *end = &entities[MAX_ENTITY];
    const NvTextHtmlEntity *e = qBinaryFind( start, end, entity );
    if ( e == end )
        return QChar();
    return e->code;
}

static const NvTextHtmlElement elements[Html_NumElements] = {
    { "!--split--",  Html_comment_split,  NvTextHtmlElement::DisplayInline },
    { "a",          Html_a,          NvTextHtmlElement::DisplayInline },
    { "address",    Html_address,    NvTextHtmlElement::DisplayInline },
    { "b",          Html_b,          NvTextHtmlElement::DisplayInline },
    { "big",        Html_big,        NvTextHtmlElement::DisplayInline },
    { "blockquote", Html_blockquote, NvTextHtmlElement::DisplayBlock },
    { "body",       Html_body,       NvTextHtmlElement::DisplayBlock },
    { "br",         Html_br,         NvTextHtmlElement::DisplayInline },
    { "center",     Html_center,     NvTextHtmlElement::DisplayBlock },
    { "cite",       Html_cite,       NvTextHtmlElement::DisplayInline },
    { "code",       Html_code,       NvTextHtmlElement::DisplayInline },
    { "dd",         Html_dd,         NvTextHtmlElement::DisplayBlock },
    { "dfn",        Html_dfn,        NvTextHtmlElement::DisplayInline },
    { "div",        Html_div,        NvTextHtmlElement::DisplayBlock },
    { "dl",         Html_dl,         NvTextHtmlElement::DisplayBlock },
    { "dt",         Html_dt,         NvTextHtmlElement::DisplayBlock },
    { "em",         Html_em,         NvTextHtmlElement::DisplayInline },
    { "font",       Html_font,       NvTextHtmlElement::DisplayInline },
    { "h1",         Html_h1,         NvTextHtmlElement::DisplayBlock },
    { "h2",         Html_h2,         NvTextHtmlElement::DisplayBlock },
    { "h3",         Html_h3,         NvTextHtmlElement::DisplayBlock },
    { "h4",         Html_h4,         NvTextHtmlElement::DisplayBlock },
    { "h5",         Html_h5,         NvTextHtmlElement::DisplayBlock },
    { "h6",         Html_h6,         NvTextHtmlElement::DisplayBlock },
    { "head",       Html_head,       NvTextHtmlElement::DisplayNone },
    { "hr",         Html_hr,         NvTextHtmlElement::DisplayBlock },
    { "html",       Html_html,       NvTextHtmlElement::DisplayInline },
    { "i",          Html_i,          NvTextHtmlElement::DisplayInline },
    { "img",        Html_img,        NvTextHtmlElement::DisplayInline },
    { "kbd",        Html_kbd,        NvTextHtmlElement::DisplayInline },
    { "li",         Html_li,         NvTextHtmlElement::DisplayBlock },
    { "link",       Html_link,       NvTextHtmlElement::DisplayNone },
    { "meta",       Html_meta,       NvTextHtmlElement::DisplayNone },
    { "nobr",       Html_nobr,       NvTextHtmlElement::DisplayInline },
    { "ol",         Html_ol,         NvTextHtmlElement::DisplayBlock },
    { "p",          Html_p,          NvTextHtmlElement::DisplayBlock },
    { "pre",        Html_pre,        NvTextHtmlElement::DisplayBlock },
    { "qt",         Html_body /*deliberate mapping*/, NvTextHtmlElement::DisplayBlock },
    { "s",          Html_s,          NvTextHtmlElement::DisplayInline },
    { "samp",       Html_samp,       NvTextHtmlElement::DisplayInline },
    { "small",      Html_small,      NvTextHtmlElement::DisplayInline },
    { "span",       Html_span,       NvTextHtmlElement::DisplayInline },
    { "strong",     Html_strong,     NvTextHtmlElement::DisplayInline },
    { "style",      Html_style,      NvTextHtmlElement::DisplayNone },
    { "sub",        Html_sub,        NvTextHtmlElement::DisplayInline },
    { "sup",        Html_sup,        NvTextHtmlElement::DisplayInline },
    { "table",      Html_table,      NvTextHtmlElement::DisplayTable },
    { "tbody",      Html_tbody,      NvTextHtmlElement::DisplayTable },
    { "td",         Html_td,         NvTextHtmlElement::DisplayBlock },
    { "tfoot",      Html_tfoot,      NvTextHtmlElement::DisplayTable },
    { "th",         Html_th,         NvTextHtmlElement::DisplayBlock },
    { "thead",      Html_thead,      NvTextHtmlElement::DisplayTable },
    { "title",      Html_title,      NvTextHtmlElement::DisplayNone },
    { "tr",         Html_tr,         NvTextHtmlElement::DisplayTable },
    { "tt",         Html_tt,         NvTextHtmlElement::DisplayInline },
    { "u",          Html_u,          NvTextHtmlElement::DisplayInline },
    { "ul",         Html_ul,         NvTextHtmlElement::DisplayBlock },
    { "var",        Html_var,        NvTextHtmlElement::DisplayInline }
};

static bool operator<( const QString &str, const NvTextHtmlElement &e )
{
    return str < QLatin1String( e.name );
}

static bool operator<( const NvTextHtmlElement &e, const QString &str )
{
    return QLatin1String( e.name ) < str;
}

static const NvTextHtmlElement *lookupElement( const QString &element )
{
    const NvTextHtmlElement *start = &elements[0];
    const NvTextHtmlElement *end = &elements[Html_NumElements];
    const NvTextHtmlElement *e = qBinaryFind( start, end, element );
    if ( e == end ) {
        return 0;
    }
    return e;
...
int NvTextHtmlParser::lookupElement( const QString &element )
{
    const NvTextHtmlElement *e = ::lookupElement( element );
    if ( !e )
        return -1;
    return e->id;
}
...
void NvTextHtmlParser::eatSpace()
{
    while ( pos < len && txt.at( pos ).isSpace() && txt.at( pos ) != QChar::ParagraphSeparator )
        pos++;
}

NvTextHtmlParserNode::NvTextHtmlParserNode()
        ...
        isTextFrame( false ), direction( 3 ), displayMode( NvTextHtmlElement::DisplayInline ),
...
{
    margin[NvTextHtmlParser::MarginLeft] = 0;
    margin[NvTextHtmlParser::MarginRight] = 0;
    margin[NvTextHtmlParser::MarginTop] = 0;
    margin[NvTextHtmlParser::MarginBottom] = 0;
    pageBreakPolicy = QTextFormat::PageBreak_Auto;
}

QTextCharFormat NvTextHtmlParserNode::charFormat() const
{
    ...
    if ( isAnchor ) {
        ...
        format.setProperty( NvTextFormat::AnchorTitle, QVariant( anchorTitle ) ); ///my code
        format.setProperty( NvTextFormat::AnchorTarget, QVariant( anchorTarget ) ); ///my code
    }
    
    format.setProperty( NvTextFormat::HasCodeStyle, QVariant( hasCodeStyle ) );   ///my code
//     if ( htmlHeading ) {
//         format.setProperty( NvTextFormat::HtmlHeading, QVariant( htmlHeading ) );  ///my code
//     }
    return format;
}

QTextBlockFormat NvTextHtmlParserNode::blockFormat() const
{
//     kDebug();
    ...
    if ( htmlHeading ) {
        format.setProperty( NvTextFormat::HtmlHeading, QVariant( htmlHeading ) );
    }   ///my code
    format.setProperty( NvTextFormat::IsBlockQuote, QVariant( isBlockQuote ) );  ///my code
    return format;
}

void NvTextHtmlParserNode::initializeProperties( const NvTextHtmlParserNode *parent, const NvTextHtmlParser *parser )
{
...
//     kDebug();
    ...
    if ( parent->displayMode == NvTextHtmlElement::DisplayNone )
        displayMode = NvTextHtmlElement::DisplayNone;
...
//     }
    ...
    switch ( id ) {
        ...
        case Html_h1:
            ...
            hasFontSizeAdjustment = true;
            margin[NvTextHtmlParser::MarginTop] = 18;
            margin[NvTextHtmlParser::MarginBottom] = 12;
            break;
        case Html_h2:
            ...
            hasFontSizeAdjustment = true;
            margin[NvTextHtmlParser::MarginTop] = 16;
            margin[NvTextHtmlParser::MarginBottom] = 12;
            break;
        case Html_h3:
            ...
            fontSizeAdjustment = 1;
            hasFontSizeAdjustment = true;
            margin[NvTextHtmlParser::MarginTop] = 14;
            margin[NvTextHtmlParser::MarginBottom] = 12;
            break;
        case Html_h4:
            ...
            hasFontSizeAdjustment = true;
            margin[NvTextHtmlParser::MarginTop] = 12;
            margin[NvTextHtmlParser::MarginBottom] = 12;
            break;
        case Html_h5:
            ...
            hasFontSizeAdjustment = true;
//             margin[NvTextHtmlParser::MarginTop] = 12;
//             margin[NvTextHtmlParser::MarginBottom] = 4;
            margin[NvTextHtmlParser::MarginTop] = 10;
            margin[NvTextHtmlParser::MarginBottom] = 12;
            break;
        case Html_h6:   ///my code
            ...
            margin[NvTextHtmlParser::MarginTop] = 8;   ///my code
            margin[NvTextHtmlParser::MarginBottom] = 12;   ///my code
            break;   ///my code
        case Html_p:
            margin[NvTextHtmlParser::MarginTop] = 12;
            margin[NvTextHtmlParser::MarginBottom] = 12;
        ...
        case Html_blockquote:
            margin[NvTextHtmlParser::MarginLeft] = 40;
            margin[NvTextHtmlParser::MarginRight] = 40;
            isBlockQuote = true;    ///my code
            break;
        case Html_dl:
            margin[NvTextHtmlParser::MarginTop] = 8;
            margin[NvTextHtmlParser::MarginBottom] = 8;
            break;
        case Html_dd:
            margin[NvTextHtmlParser::MarginLeft] = 30;
            break;
        case Html_u:
            fontUnderline = On;
            break;
...
void NvTextHtmlParserNode::applyCssDeclarations( const QVector<QCss::Declaration> &declarations, const QTextDocument *resourceProvider )
{
                ...
                if ( decl.values.first().type == QCss::Value::KnownIdentifier ) {
                    switch ( decl.values.first().variant.toInt() ) {
                        case QCss::Value_Normal:
                            wsm = NvTextHtmlParserNode::WhiteSpaceNormal;
                            break;
                        case QCss::Value_Pre:
                            wsm = NvTextHtmlParserNode::WhiteSpacePre;
                            break;
                        case QCss::Value_NoWrap:
                            wsm = NvTextHtmlParserNode::WhiteSpaceNoWrap;
                            break;
                        case QCss::Value_PreWrap:
                            wsm = NvTextHtmlParserNode::WhiteSpacePreWrap;
                            break;
                        default:
                            break;
                    }
...
NvTextHtmlParserNode *NvTextHtmlParser::newNode( int parent )
{
//     kDebug();
    NvTextHtmlParserNode *lastNode = &nodes.last();
    NvTextHtmlParserNode *newNode = 0;
        ...
        if ( lastNode->text.isEmpty() ) {
            ...
            if ( lastNode->text == QLatin1String( " " ) ) {
                ...
                while ( lastSibling && at( lastSibling ).parent != lastNode->parent &&
                        at( lastSibling ).displayMode == NvTextHtmlElement::DisplayInline ) {
                    lastSibling = at( lastSibling ).parent;
                }

                if ( at( lastSibling ).displayMode == NvTextHtmlElement::DisplayInline ) {
                    reuseLastNode = false;
                } else {
                    reuseLastNode = true;
                }
...
void NvTextHtmlParser::parse( const QString &text, const QTextDocument *_resourceProvider )
{
//     kDebug();
    nodes.clear();
    nodes.resize( 1 );
...
int NvTextHtmlParser::depth( int i ) const
{
    int depth = 0;
    while ( i ) {
        i = at( i ).parent;
...
int NvTextHtmlParser::margin( int i, int mar ) const
{
    int m = 0;
    const NvTextHtmlParserNode *node;
    if ( mar == MarginLeft
            || mar == MarginRight ) {
        while ( i ) {
            node = &at( i );
...
int NvTextHtmlParser::topMargin( int i ) const
{
    if ( !i )
        return 0;
...
int NvTextHtmlParser::bottomMargin( int i ) const
{
    if ( !i )
        return 0;
...
// void NvTextHtmlParser::parse() {
//  NvTextHtmlParserNode::WhiteSpaceMode wsm = NvTextHtmlParserNode::WhiteSpaceNormal;
//  while (pos < len) {
//   QChar c = txt.at(pos++);
//   if (c == QLatin1Char('<')) {
//    NvTextHtmlParser::parseTag();
//    wsm = nodes.last().wsm;
    ...
    while ( pos < len ) {
        ...
        if ( c == QLatin1Char( '<' ) ) {
            ...
            if ( c.isSpace() && c != QChar( QChar::Nbsp ) && c != QChar::ParagraphSeparator ) {
                if ( wsm == NvTextHtmlParserNode::WhiteSpacePre || textEditMode ) {
		     if ( c == QLatin1Char( '\n' ) ) {
                        if ( textEditMode )
                            continue;
			else
                ...
                } else if ( wsm != NvTextHtmlParserNode::WhiteSpacePreWrap ) { // non-pre mode: collapse whitespace except nbsp
                    while ( pos < len && txt.at( pos ).isSpace() && txt.at( pos ) != QChar::Nbsp ) {
                        pos++;
                    }
                    if ( wsm == NvTextHtmlParserNode::WhiteSpaceNoWrap ) {
                        c = QChar::Nbsp;
                    } else {
                        c = QLatin1Char( ' ' );
                    }
...
// parses a tag after "<"
void NvTextHtmlParser::parseTag()
{
//     kDebug();
    eatSpace();
...
//         parseExclamationTag();
        if ( parseExclamationTag() ) {
            if ( nodes.last().wsm != NvTextHtmlParserNode::WhiteSpacePre
                    && nodes.last().wsm != NvTextHtmlParserNode::WhiteSpacePreWrap
                    && !textEditMode )
                eatSpace();
            return;
        } else {
    ...
    NvTextHtmlParserNode *node = newNode( p );
    const int nodeIndex = int( QVector<NvTextHtmlParserNode>::const_iterator( node ) -
                               nodes.constBegin() );
...
//     kDebug() << node->tag;
    ...
    const NvTextHtmlElement *elem = ::lookupElement( node->tag );
    if ( elem ) {
        node->id = elem->id;
        node->isBlock = ( elem->displayMode == NvTextHtmlElement::DisplayBlock );
...
//     bool tagClosed = false;
    ...
    if ( node->wsm != NvTextHtmlParserNode::WhiteSpacePre
            && node->wsm != NvTextHtmlParserNode::WhiteSpacePreWrap
...
// parses a tag beginning with "!"
bool NvTextHtmlParser::parseExclamationTag()
{
    ++pos;
...
void NvTextHtmlParser::parseCloseTag()
{
//     kDebug();
    ++pos;
...
QString NvTextHtmlParser::parseEntity()
{
//     kDebug();
    int recover = pos;
    QString entity;
...
QString NvTextHtmlParser::parseWord()
{
//     kDebug();
    QString word;
...
QStringList NvTextHtmlParser::parseAttributes()
{
//     kDebug();
    QStringList attrs;
...
void NvTextHtmlParser::resolveParent()
{
//     kDebug();
    NvTextHtmlParserNode *node = &nodes.last();
    int p = node->parent;
...
static void parseStyleAttribute( NvTextHtmlParserNode *node, const QString &value, const QTextDocument *resourceProvider )
{
    QString css = value;
...
void NvTextHtmlParser::applyAttributes( const QStringList &attributes )
{
//     kDebug();
...
void NvTextHtmlParser::resolveNode()
{
    NvTextHtmlParserNode *node = &nodes.last();
    const NvTextHtmlParserNode *parent = &nodes.at( node->parent );
    node->initializeProperties( parent, this );
}

bool NvTextHtmlParserNode::isNestedList( const NvTextHtmlParser *parser ) const
{
    if ( !isListStart )
        return false;
...
{
public:
    inline QTextHtmlStyleSelector( const NvTextHtmlParser *parser )
            : parser( parser ) {}
...
void NvTextHtmlParser::resolveStyleSheetImports( const QCss::StyleSheet &sheet )
{
...
void NvTextHtmlParser::importStyleSheet( const QString &href )
{
...
QVector<QCss::Declaration> NvTextHtmlParser::declarationsForNode( int node ) const
{
